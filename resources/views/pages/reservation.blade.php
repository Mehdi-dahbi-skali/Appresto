        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-content bg-white p-5 shadow">
                    ...
                    <form method="POST" name="contact-us" action="{{ route('reservationpp')}}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                    <input name="date" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker4" placeholder="Date" />
                            ...
                            <div class="col-md-6 form-group">
                                <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                    <input name="time" type="text" class="form-control datetimepicker-input"  placeholder="Time" />
                            ...
                            <div class="col-md-12 form-group">
                                <select name="person" class="form-control" id="selectPerson">
                                    <option></option>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
